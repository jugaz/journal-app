...
describe('Vuex: Pruebas en el auth-module', () => {
    ...
    test('Mutation: loginUser', () => {
        ...
        const payload = {
            user: { name: 'Jesús', email: 'jesus@gmail.com' },
            idToken: 'ABC-123',
        ...
        expect( user ).toEqual( { name: 'Jesús', email: 'jesus@gmail.com' } )
    ...
    test('Getter: username currentState', () => {
        ...
        expect( store.getters['auth/username'] ).toBe('Jesús')
    ...
    test('Actions: createUser signInUser - Crea el usuario', async() => {
        ...
        // Borrar el usuario
        const deleteResp = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:delete?key=AIzaSyD1Z3gqQYBd-_kgnscWnEyGlt8bv3XY7ww`, {
            idToken
        })
